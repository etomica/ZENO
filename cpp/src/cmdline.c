/*
  ...
  gengetopt -i /home/arpit/windows/arpit/CLionProjects/ZENO/cpp/src/options.ggo --conf-parser --output-dir=/home/arpit/windows/arpit/CLionProjects/ZENO/cpp/src 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --virial-steps=LONGLONG   Number of Monte Carlo steps to perform to\n                                  compute a virial coefficient. Fewer steps may\n                                  be performed if another stopping condition is\n                                  reached first",
  "      --max-rsd-virial-coefficient=DOUBLE\n                                Performs Monte Carlo steps to compute virial\n                                  coefficient until the relative standard\n                                  deviation of the virial coefficient drops\n                                  below this value.  This value may not be\n                                  reached if another stopping condition is\n                                  reached first.  Relative standard deviation\n                                  is defined as (Standard_Deviation/Mean)*100%",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_rsd_virial_coefficient_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_rsd_virial_coefficient_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_rsd_virial_coefficient_help = gengetopt_args_info_help[20] ;
  args_info->virial_coefficient_order_help = gengetopt_args_info_help[21] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->max_rsd_virial_coefficient_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->max_rsd_virial_coefficient_given)
    write_into_file(outfile, "max-rsd-virial-coefficient", args_info->max_rsd_virial_coefficient_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "max-rsd-virial-coefficient",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Number of Monte Carlo steps to perform to compute a virial coefficient. Fewer steps may be performed if another stopping condition is reached first.  */
          ...
          /* Performs Monte Carlo steps to compute virial coefficient until the relative standard deviation of the virial coefficient drops below this value.  This value may not be reached if another stopping condition is reached first.  Relative standard deviation is defined as (Standard_Deviation/Mean)*100%.  */
          else if (strcmp (long_options[option_index].name, "max-rsd-virial-coefficient") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->max_rsd_virial_coefficient_arg), 
                 &(args_info->max_rsd_virial_coefficient_orig), &(args_info->max_rsd_virial_coefficient_given),
                &(local_args_info.max_rsd_virial_coefficient_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "max-rsd-virial-coefficient", '-',
                additional_error))
              goto failure;
